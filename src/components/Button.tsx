...
export default function Button({ variant, active = false, onClick, children, className = '', disabled = false }: ButtonProps) {
  const baseStyles = 'font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2'
  
  const variantStyles = {
    navigation: 'p-2 rounded-lg bg-white border border-gray-200 shadow-sm hover:bg-gray-50 focus:ring-blue-500',
    ...
    secondary: 'px-4 py-2 rounded-lg text-sm bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white shadow-sm border border-green-600 focus:ring-green-500'
  }
