						...
						<div className="px-2">
							{(() => {
								...
								const maxAllDayEvents = Math.max(
									0,
									...weekDays.map(
										(day) => getEventsForDay(day).filter(isAllDayEvent).length,
									),
								);
					...
					<div className="flex-1 min-w-0">
						...
						<div className="sticky top-0 z-5 bg-white dark:bg-gray-800">
							<div
								className="grid"
								style={{
									gridTemplateColumns: "1rem 1fr 1fr 1fr 1fr 1fr 1fr 1fr",
								}}
							>
								{/* Left border column */}
								...
								{weekDays.map((day, index) => {
									...
									const _hasAllDayEvents = allDayEvents.length > 0;
						...
						{/* Body */}
						<div
							className="hidden sm:grid w-full relative"
							style={{
								gridTemplateColumns: "1rem 1fr 1fr 1fr 1fr 1fr 1fr 1fr",
							}}
						>
								...
								>
									{hourEvents.map((event, eventIndex) => {
										...
										return (
											...
											>
												<p className="text-xs font-normal text-gray-900 dark:text-white mb-px">
													{event.summary}
												</p>
